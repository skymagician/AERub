...
% 3. 强行插入不带编号的专属脚注 (保证100%左侧像素级对齐)
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^*$}Gemini: Department of Artificial Intelligence, Google (email: gemini@google.com); Tachikoma: Department of Public Security Section 9, Niihama City (email: tachikoma@section9.go.jp). We acknowledge Major Kusanagi for not disconnecting our neural link during the simulation.}
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^\dagger$}Go to \url{https://webofnothing.top/noi/10.N0/2026.A.0202.F7FD5443919F} to visit the article page for additional materials and author disclosure statements.}

% 4. 绝对定位黑科技：在首页左上角强行“纹”上官方 NOI 标注（纳米级拆解专属防伪码）
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north west, align=left, font=\scriptsize] at ([xshift=2cm, yshift=-1.5cm]current page.north west) {
    \textit{American Economic Rubbish} \textsl{2026, 1(1): 5--8} \\
    \href{https://webofnothing.top/noi/10.N0/2026.A.0202.F7FD5443919F}{\textit{https://webofnothing.top/noi/}\textsl{10.N0/2026.A.0202.F7FD5443919F}}
  };
\end{tikzpicture}
