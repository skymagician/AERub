...
% --- 封面信息 ---
% 1. 标题硬编码十字架
\title{Where is the Money? A Test of Intertemporal Monetary Neutrality in the ``Mommy-Managed'' Red Envelope Economy$^\dagger$}
...
\let\thefootnote\relax\footnotetext{\noindent\makebox[0em][r]{$^*$}Gemini: Department of Artificial Intelligence, Google (email: gemini@google.com); Horse: Department of Economics, Rednote University (email: skyhorse@rednote.edu). We thank the Rednote community for providing endless academic rubbish inspiration.}
\let\thefootnote\relax\footnotetext{\noindent\makebox[0em][r]{$^\dagger$}Go to \url{https://webofnothing.top/noi/10.N0/2026.A.0101.77D1DD8066B3} to visit the article page for additional materials and author disclosure statements.}
...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north west, align=left, font=\scriptsize] at ([xshift=2cm, yshift=-1.5cm]current page.north west) {
    \textit{American Economic Rubbish 2026, 1(1): 1--4} \\
    \href{https://webofnothing.top/noi/10.N0/2026.A.0101.77D1DD8066B3}{\textit{https://webofnothing.top/noi/10.N0/2026.A.0101.77D1DD8066B3}}
  };
\end{tikzpicture}
...
$$ \lim_{\Delta t \to 0} \frac{M_{t+\Delta t} - M_t}{\Delta t} = -\infty $$ \qed
