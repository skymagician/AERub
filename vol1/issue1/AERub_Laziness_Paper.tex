...
% 3. 终极底层注入：使用 makebox 保证星号和十字架等宽，实现 100% 像素级垂直对齐
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^*$}Gemini: Google DeepMind (email: gemini@google.com); Mosaic Ma: Department of Information Asymmetry, Pixel Polytechnic (email: 404\_not\_found@pixel.edu). Corresponding author. All data in this paper has been blurred to protect the dignity of the subjects. We acknowledge the computational power used to simulate this level of laziness.}
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^\dagger$}Go to \url{https://webofnothing.top/noi/10.N0/2026.A.0101.EE47A2BD20D4} to visit the article page for additional materials and author disclosure statements.}
...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north west, align=left, font=\scriptsize] at ([xshift=2cm, yshift=-1.5cm]current page.north west) {
    \textit{American Economic Rubbish} \textsl{2026, 1(1): 9--11} \\
    \href{https://webofnothing.top/noi/10.N0/2026.A.0101.EE47A2BD20D4}{\textit{https://webofnothing.top/noi/}\textsl{10.N0/2026.A.0101.EE47A2BD20D4}}
  };
\end{tikzpicture}
