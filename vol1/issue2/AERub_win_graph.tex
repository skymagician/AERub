...
\title{A Win-graph-based Proof of the Champion Inequality$^\dagger$}
...
\pubIssue{2}
% \JEL{C00, D00, Z19}
% \Keywords{Champion inequality, winnology, winmability, runnology}
...
\noindent (\textit{JEL} C00, D00, Z19)
\end{abstract}

\maketitle

% 3. 连续两次强行注入！完全绕开底层队列！
\let\thefootnote\relax\footnotetext{$^*$ Nguyen: School of Winnology, Vietnam Normal University (email: ketuguyen@vnu.edu.cn).}
\let\thefootnote\relax\footnotetext{$^\dagger$ Go to \url{https://webofnothing.top/noi/10.N0/aer.202603.A.0404.0002} to visit the article page for additional materials and author disclosure statements.}
...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north west, align=left, font=\scriptsize] at ([xshift=2cm, yshift=-1.5cm]current page.north west) {
    \textit{American Economic Rubbish} \textsl{2026, 1(2): 10--13} \\
    \href{https://webofnothing.top/noi/10.N0/aer.202603.A.0404.0002}{\textit{https://webofnothing.top/noi/}\textsl{10.N0/}\textit{aer.}\textsl{202603.A.0404.0002}}
  };
\end{tikzpicture}
