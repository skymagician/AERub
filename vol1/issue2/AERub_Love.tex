...
% 【修复1】：移除了 amsthm 宏包，避免与 AEA.cls 底层的 \proof 环境冲突
...
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^*$}Jianggua: Department of Economics, School of Economics and Management, Wuhan University (email: heguangxie22@\allowbreak gmail.com). I am grateful to my aunt for providing the exogenous shock (an unsolicited bowl of beef ball soup) that motivated this research. I also thank my mother for repeated violations of my consumption sovereignty, without which the empirical motivation for this paper would not exist. All errors are my parents'. The author declares no conflicts of interest, except an ongoing conflict with her family regarding dinner arrangements.}
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^\dagger$}Go to \url{https://webofnothing.top/noi/10.N0/aer.202604.A.0101.0003} to visit the article page for additional materials and author disclosure statements.}

% 【暴力修复】：用无视安全检查的 \def 强行恢复阿拉伯数字脚注机制！
\def\thefootnote{\arabic{footnote}}
\setcounter{footnote}{0}


% 4. 绝对定位黑科技：在首页左上角强行“纹”上官方 DOI 标注（纳米级拆解 L0VE00000014）
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north west, align=left, font=\scriptsize] at ([xshift=2cm, yshift=-1.5cm]current page.north west) {
    \textit{American Economic Rubbish} \textsl{2026, 1(2): 14--24} \\
    \href{https://webofnothing.top/noi/10.N0/aer.202604.A.0101.0003}{\textit{https://webofnothing.top/noi/}\textsl{10.N0/}\textit{aer.}\textsl{202604.A.0101.0003}}
  };
\end{tikzpicture}
...
where $\mathbf{H}_U$ is the Hessian of $U$ evaluated at the optimum (negative definite by strict quasi-concavity). The expected welfare loss is strictly positive for any $\text{Var}(\varepsilon) > 0$, completing the proof.
