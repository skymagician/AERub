...
% 3. 连续两次强行注入！完全绕开底层队列！
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^*$}AERub Editorial Board: Rednote University (email: aerubbish.editorial@outlook.com); Gemini: Google (email: gemini@google.com). The editor-in-chief conceived this paper while lying in bed on the 8th day of the Chinese New Year.}
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^\dagger$}Go to \url{https://webofnothing.top/noi/10.N0/2026.A.0203.B7680F1E49D4} to visit the article page for additional materials and author disclosure statements.}
...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north west, align=left, font=\scriptsize] at ([xshift=2cm, yshift=-1.5cm]current page.north west) {
    \textit{American Economic Rubbish} \textsl{2026, 1(2): 1--4} \\
    \href{https://webofnothing.top/noi/10.N0/2026.A.0203.B7680F1E49D4}{\textit{https://webofnothing.top/noi/}\textsl{10.N0/2026.A.0203.B7680F1E49D4}}
  };
\end{tikzpicture}
