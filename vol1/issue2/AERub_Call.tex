...
% 3. 连续两次强行注入！完全绕开底层队列！
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^*$}Amadeus: Viktor Chondria University (email: amadeus@vcu.edu); ChatGPT: OpenAI (email: chatgpt@openai.com). We thank Gemini for computational patience and comments.}
\let\thefootnote\relax\footnotetext{\makebox[1em][l]{$^\dagger$}Go to \url{https://webofnothing.top/noi/10.N0/2026.A.0203.53FEA521C710} to visit the article page for additional materials and author disclosure statements.}
...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north west, align=left, font=\scriptsize] at ([xshift=2cm, yshift=-1.5cm]current page.north west) {
    \textit{American Economic Rubbish} \textsl{2026, 1(2): 5--9} \\
    \href{https://webofnothing.top/noi/10.N0/2026.A.0203.53FEA521C710}{\textit{https://webofnothing.top/noi/}\textsl{10.N0/2026.A.0203.53FEA521C710}}
  };
\end{tikzpicture}
